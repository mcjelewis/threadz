...
var makeStatistics = function(data){
  ...
  $('#dataGrid').html("");
  var peopleTable = tabulate(snaData.nodes, ["name", "post_count", "word_count", "word_count_avg"], "dataGrid");

  //console.log(snaData.threads);
  var arrThreadStat = snaData.threads.filter(function(){return true;});
  //console.log(arrThreadStat);
    $('#threadStats').html("");
  var threadTable = tabulate(arrThreadStat, ["thread", "posted_wordCount", "total_wordCount", "ratio"], "threadStats");
...
//var previewTable = tabulate(statsTable, ["totalParticipats", "totalPosts"], "previewbox");
  
//console.log(statsTable.users);
