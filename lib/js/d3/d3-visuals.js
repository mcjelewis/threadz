...
function setNodeLinks(data){
  console.log(data);
    ...
    for(var item in data["nodes"]){
      ...
      arr.userData.people[data["nodes"][item].canvas_id] = {"canvas_id": data["nodes"][item].canvas_id, "name": data["nodes"][item].name, "initials": data["nodes"][item].initials, "post_count": data["nodes"][item].post_count, "posts_received": data["nodes"][item].posts_received, "word_count": 100, "word_count_avg": 0, "group": 1, "deleted": 0};
